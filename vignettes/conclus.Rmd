...
statistical task. In short, it involves  attempting to find groups
(clusters) into which objects
...
and [stochastic gradient boosting](http://statweb.stanford.edu/~jhf/ftp/stobst.pdf)
algorithms.
